...
title = Asistente Predicación Bilingüe

# (str) Package name
package.name = asistente_predicacion
...
source.exclude_patterns = venv/*,*.pyc,__pycache__/*,*.pyo,*.spec
...
#android.library_references = @aar/your_lib_name,@jar/your_lib_name
...
# (bool) If True, the android app will be split into aab format, otherwise apk
...
#    and extend the requirements to remove the HD content.
#
#    [app@demo]
